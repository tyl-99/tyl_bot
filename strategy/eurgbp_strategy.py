...
class EURGBPStrategy:
    ...
    def __init__(self, target_pair="EUR/GBP",
        ...
        self.pip_size = 0.0001 # Corrected for non-JPY pairs
    ...
    def _get_news_sentiment(self, current_datetime: datetime.datetime) -> str:
        ...
        try:
            ...
            params = {
                "currencypair": "EUR-GBP", # Updated for EUR/GBP
                "items": 10,
                "date": "today",
                "token": token,
            }
            ...
            bull_kw = ["euro rises", "gbp weak", "risk-on", "bullish", "hawkish ecb"] # Updated for EUR/GBP
            bear_kw = ["euro falls", "gbp strong", "risk-off", "bearish", "dovish ecb"] # Updated for EUR/GBP
